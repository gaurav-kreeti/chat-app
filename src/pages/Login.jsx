...
const Login = () => {
  ...
  return <>
    {/* <h1 className="text-white text-center p-2 text-2xl">Please LogIN</h1>
    <form onSubmit={handleUserLogin} className="flex flex-col gap-3">
      ...
      <input className="p-2 mt-2 text-white" type="submit" />
    </form> */}
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" onSubmit={handleUserLogin}>
                  <div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      New User? <Link to="/register" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Create Account</Link>
                  </p>
              </form>
          </div>
      </div>
