          ...
          <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                ...
                <div>
                  <label htmlFor="profile_pic" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload profile pic</label>
                  <input type="file" id="profile_pic" className="cursor-pointer rounded-lg "/>
                </div>
                <button
                  type="submit"
